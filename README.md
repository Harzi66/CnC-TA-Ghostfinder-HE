...
2. Die Datei **`CnC-TA-Ghostfinder-HE.user.js`** öffnen.
3. In GitHub auf **Raw** klicken.
4. Tampermonkey öffnet die Installationsseite.
5. Script installieren.
6. C&C Tiberium Alliances neu laden bzw. das Spiel öffnen.
7. Das Script anschließend über das **Scripte-Menü** starten.
